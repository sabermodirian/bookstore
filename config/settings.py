...
SECRET_KEY = 'django-insecure-ni8l)89s%wth$fkf%vg6q(rbh%v*7#1ryyt6fhebp3+82clvdo'
...
TEMPLATES = [
    {
        ...
        'DIRS': [str(BASE_DIR.joinpath('templates'))], # برای پیدا کردن هر تمپلیتی در این آدرس هم بگرد
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
